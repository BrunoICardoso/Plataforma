...
BubbleChart = (function () {
    function BubbleChart(data) {
        ...
        this.color_mapper = this.get_color_map_lookup_set(data);
    ...
    BubbleChart.prototype.get_map_max_values = function (data) {
        ...
        //        return parseFloat(d.frequencia)
        //    } 
        //});
        ...
        //    } 
        //});
        //max_values_map["Produto"] = d3.max(data, function (d) {
        //    if (d.Categoria == 'Produto') {
        //        return parseFloat(d.frequencia)
        //    } 
        //})
    ...
    BubbleChart.prototype.create_nodes = function () {
        ...
        return this.data.forEach((function (_this) {
            return function (d, i) {
                ...
                var radiusNode = parseInt(parseFloat(d.frequencia) * _this.max_radius / maxvalue);
                if (radiusNode < 5) {
                    radiusNode = 5;
                }
                var node;
                node = {
                    ...
                    radius: radiusNode,
                    value: 99,
                    color: _this.color_mapper[d.termo],
    ...
    BubbleChart.prototype.create_vis = function () {
        var that;
        this.vis = d3.select("#bubble_termos").append("svg").attr("width", this.width).attr("height", this.height).attr("id", "svg_vis");
    ...
    BubbleChart.prototype.get_color_map_lookup_set = function (allValuesArray) {
        ...
        baseArray = ["#3D89A1", "#BD6567", "#0195AE", "#E27686", "#51C2C6", "#C7AEAC", "#9FCFD3", "#D7C6C4", "#31B59B", "#BA9653", "#6BC6B5", "#A3A13A", "#5EB0D8", "#B6B345", "#87C5E1", "#D2D087", "#DFA660", "#B8B1B8", "#FAC14D", "#BEBFC4", "#E6BB88", "#D0D1D5", "#FAD79F"];
        index = 0;
        color_map = {};
        for (j = 0, len = allValuesArray.length; j < len; j++) {
            value = allValuesArray[j].termo;
    ...
    BubbleChart.prototype.show_details = function (data, i, element) {
        ...
        //}
        content += "<span class=\"name\">Termo:</span><span class=\"value\"> " + ref.termo + "</span><br/>";
        content += "<span class=\"name\">Frequência:</span><span class=\"value\"> " + ref.frequencia+ "</span><br/>";
    ...
    BubbleChart.prototype.use_filters = function (filters) {
        return this.nodes.forEach((function (_this) {
            return function (d) {
                d.radius = parseInt(parseFloat(d.original.frequencia) * _this.max_radius / _this.max_values_map[d.original.Categoria]);
                if (d.radius < 5) {
                    d.radius = 5;
                }
...
$(function () {
    ...
    //    };
    //})(this);
    //return d3.csv("/data/noticias_empresa.csv", render_vis);
});
