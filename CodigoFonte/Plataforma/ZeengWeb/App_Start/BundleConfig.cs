...
namespace ZeengWeb
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/plugins/lightboxGallery").Include(
            ...
            bundles.Add(new ScriptBundle("~/plugins/chartJs221").Include(
                      "~/Scripts/plugins/chartjs221/Chart.js"));
            ...
            bundles.Add(new ScriptBundle("~/plugins/vectorMap").Include(
                      ...
                      "~/Scripts/plugins/jvectormap/brazil-jvectormap.js"
                      ));
            ...
            bundles.Add(new StyleBundle("~/Content/plugins/ionRangeSlider/ionRangeStyles").Include(
                      ...
                      "~/Content/plugins/ionRangeSlider/ion.rangeSlider.skinGreen.css"));
            ...
            // Vis Bubble Chart
            bundles.Add(new ScriptBundle("~/vis").Include(
                      //"~/Scripts/vis_files/modernizr-2.0.6.min.js",
                      //"~/Scripts/vis_files/plugins.js",
                      "~/Scripts/vis_files/script.js",
                      "~/Scripts/vis_files/CustomTooltip.js",
                      "~/Scripts/plugins/d3/d3.v3.js"
                      //"~/Scripts/vis_files/coffee-script.js",
                      //"~/Scripts/vis_files/d3.min.js",
                      //"~/Scripts/vis_files/d3.csv.min.js",
                      //"~/Scripts/vis_files/d3.layout.min.js",
                      //"~/Scripts/vis_files/d3.geom.min.js"
                      ));
