...
BubbleChart = (function () {
    ...
    BubbleChart.prototype.get_color_map_lookup_set = function (allValuesArray) {
        ...
        baseArray = ["#3D89A1", "#BD6567", "#0195AE", "#0195AE", "#51C2C6", "#C7AEAC", "#9FCFD3", "#D7C6C4", "#31B59B", "#BA9653", "#6BC6B5", "#A3A13A", "#5EB0D8", "#B6B345", "#87C5E1", "#D2D087", "#DFA660", "#B8B1B8", "#FAC14D", "#BEBFC4", "#E6BB88", "#D0D1D5", "#FAD79F"];
        index = 0;
        color_map = {};
        for (j = 0, len = allValuesArray.length; j < len; j++) {
            value = allValuesArray[j];
